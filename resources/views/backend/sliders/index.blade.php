        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" id="form" method="POST" enctype="multipart/form-data">
                    ...
                    {{-- <div class="form-group row">
                        <div class="col-md-6">
                            <label for="title_en" class="col-form-label form-control-label">Заголовок_en</label>
                            <input class="form-control" type="text" id="title_en" name="title_en">
                        </div>
                        <div class="col-md-6">
                            <label for="short_text_en" class="col-form-label form-control-label">Краткий текст_en</label>
