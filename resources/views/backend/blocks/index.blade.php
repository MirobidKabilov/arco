        ...
        <div class="col-lg-6 col-7">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                    <li class="breadcrumb-item"><a href="#">Блоки</a></li>
                </ol>
            </nav>
        </div>
    ...
    <div class="modal-dialog apartment-modal" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">БЛОКИ</h5>
            ...
            <div class="modal-body">
                <form action="" id="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <label for="name_en" class="col-form-label form-control-label">Название (UZ)</label>
...
<script>
  var crud = new Crud({
    filter: true,
    form: {
      url: "{{ route('backend.blocks.form') }}",
    },

    list: {
      url: "{{route('backend.blocks.data')}}",
      datatable: {            
        columns: [
          {data: 'id', name: 'id'},
        ...
        columnDefs: [
            {
                ...
                render: function (row, type, val, meta) {
                    return '<div class="text-right">' + '<a href="' + row.floor_url + '" class="btn btn-outline-default">Этажи</a>' +
                    crud.makeButton(val, 'btn-default btn-edit', '<i class="fa fa-pen"></i>', [
                        ['toggle', 'modal'],
                        ['target', '#formModal']
                    ]) +
					(val.floors_count > 0 ? "<button class='btn btn-danger' disabled>" + '<i class="fa fa-trash"></i>' + "</button>" : 
    ...
    remove: {
      url: "{{ route('backend.blocks.delete') }}",
    }
  })
</script>
@endsection